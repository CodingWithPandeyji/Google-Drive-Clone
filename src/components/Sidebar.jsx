            ...
            >
                ...
                >
                    <div className='relative w-full'>
                        <p className='font-medium mb-3 text-center text-xl'>Select file you want to upload</p>
                        <button
                    ...
                    </div>
                    {
                        theme === 'dark' ? (uploading ? 
                            <input className='px-5 py-2 rounded-lg bg-[#315ebe] text-white font-semibold w-[100%]' value='Uploading...' disabled type="submit" /> :
                            <input
                                onClick={handleUpload}
                                className='hover-transition px-5 py-2 rounded-lg cursor-pointer bg-white hover:bg-[#315ebe]  text-[#030712] font-medium '
                                value='Upload'
                                type="submit"
                            />
                        ) : (
                            uploading ? 
                            <input className='px-5 py-2 rounded-lg bg-emerald-600 text-[#fcfdff] font-semibold w-[100%] mt-3' value='Uploading...' disabled type="submit" />
                            : <input
                                onClick={handleUpload}
                                className='hover-transition px-5 py-2 rounded-lg cursor-pointer bg-[#217FF7] hover:bg-[#282f3c] text-white font-semibold w-[100%] mt-5'
                                value='Upload'
                                type="submit"
                            />
                        )
            ...
            <div className='2xl:w-[15%] xl:w-[20%] lg:w-[25%] w-[8%] md:block hidden'>
                ...
                >
                    ...
                    <div className='flex flex-col w-full'>
                        <div className={`flex gap-2  text-l items-center ${theme === 'light' ? 'bg-blue-100' : 'bg-[#172554]'} lg:py-2 py-4 px-4 lg:justify-start justify-center rounded-full`}>
                            <HomeOutlinedIcon />
                            <p className='lg:block hidden'>Home</p>
                        </div>
                        <div className={`flex gap-2 text-l items-center lg:py-2 py-4 px-4 lg:justify-start justify-center rounded-full ${theme === 'light' ? 'hover:bg-slate-200' : 'hover:bg-[#1E293B]'} cursor-pointer`}>
                            <FolderOutlinedIcon />
