            ...
            >
                ...
                >
                    <div className='flex justify-between items-center px-5 py-5'>
                        <p className='font-normal text-xl'>App Guide</p>
                    ...
                    >
                        ...
                        <div className='relative'>
                            ...
                            {sortMenu && (
                                ...
                                >
                                    <p className='font-medium px-5 py-2 bg-slate-200'>Sort By</p>
                                    {
                                        theme === 'dark' ? (
                                            <>
                                                <p 
                            ...
                            >
                                {
                                    theme === 'dark' ? (
                                        ...
                                        <>
                                            <p className='px-5 py-2 font-medium bg-slate-200'>Theme</p>
