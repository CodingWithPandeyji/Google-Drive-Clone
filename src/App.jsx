      ...
      {user ? (
        ...
        <>
          <div className="flex justify-between items-center px-10 py-4 text-[#52525b]">
            ...
            <button
              className="hover-transition bg-blue-500 hover:bg-[#2563EB] px-10 py-3 font-mormal text-xl rounded-lg text-white"
              onClick={signIn}
            >
              Log In
            </button>
          ...
          <div className="flex gap-5 my-8">
            <div className="lg:w-1/2 md:w-5/6 w-full lg:mx-0 mx-auto lg:my-0 my-10 flex flex-col items-start justify-center gap-10 px-12">
              <p className="md:text-6xl text-5xl font-bold">Easy and secure access to your content</p>
              ...
              <button
                className="hover-transition bg-blue-500 hover:bg-[#2563EB] text-xl px-10 py-3 font-medium rounded-lg text-white"
                onClick={signIn}
              >
                Log In
              </button>
